...
# Entry point - Chart data handling routes

# API: Get all patient names in database
...
def get_chart_data():
    ...
    # Initialize counters for general health data
    emotion = {"Yes": 0, "No": 0}
    pain = {"Yes": 0, "No": 0}
    ...
    #------------------------- Occupational Therapy Charts ------------------------------------------
        ...
        # Dictionary for mapping text values to numeric scores
    ...
    #------------------------- Psychology Charts ------------------------------------------
        ...
        # Mapping q15: Yes -> 1, No -> 0 for chart display
...
# API: Download patient data as CSV based on therapist specialty
